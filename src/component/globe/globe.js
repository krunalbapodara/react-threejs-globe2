...
class GlobeModule extends Component {
  ...
  init = (data, opts) => {
    ...
    const props = {
      ...
      colours: {
        ...
        lines: new THREE.Color("#fff"),
        lineDots: new THREE.Color("#fff")
      },
      alphas: {
    ...
    const addGlobe = () => {
      ...
      canvasGradient.addColorStop(.5, '#191717');
    ...
    var animate = function () {
     ...
     // groups.galaxy.rotation.y += 0.003;
      groups.globe.rotation.y += 0.003;
  ...
  render() {
    return (
      <GlobeContainer>
        <div className="globe js-globe" style={{background:"url("+require('./starfield2_1900x1250.jpg')+")"}} ref={ref => (this.mount = ref)} >
